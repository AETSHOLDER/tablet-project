...
public class BroadcastUDPWuHuService extends Service {
    /**
     *
     */
    ...
    private void init() {
        CONTROL_PORT = constant.WuHu_PORT;
        try {
    ...
    public class BroadcastUDPFileServiceBinder extends Binder {
        public BroadcastUDPWuHuService getService() {
            return BroadcastUDPWuHuService.this;
        }
    }
