...
public class WuHuRadioAdapter extends BaseAdapter {
   ...
   // List< VoteListBean.VoteBean.UserListBean>  userListBeanList;
    ...
    public WuHuRadioAdapter(Context context, List<ChoseBean> list, String flag,  VoteListBean.VoteBean  voteBean ) {
        listData = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View view;
    final     WuHuRadioAdapter.ViewHolder viewHolder ;
        if (convertView == null) {
            ...
            viewHolder = new WuHuRadioAdapter.ViewHolder(view);
            view.setTag(viewHolder);
        } else {
            view = convertView;
            viewHolder = (WuHuRadioAdapter.ViewHolder) view.getTag();
        }
        switch (position){
            case  0:
