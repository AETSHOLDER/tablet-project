...
public class LocationFileListAdapter extends BaseAdapter {
    ...
    public LocationFileListAdapter.upLoadFileInterface getUpLoadFileInterface() {
        return upLoadFileInterface;
    }

    public void setUpLoadFileInterface(LocationFileListAdapter.upLoadFileInterface upLoadFileInterface) {
    ...
    public LocationFileListAdapter(Context context, List<FileListBean> gridViewBeanList) {
