...
public class PrivateFileListAdapter extends BaseAdapter {
    ...
    public PrivateToPublicInterface getPrivateToPublicInterface() {
        return privateToPublicInterface;
    }

    public void setPrivateToPublicInterface(PrivateToPublicInterface privateToPublicInterface) {
        this.privateToPublicInterface = privateToPublicInterface;
    }
    ...
    public PrivateFileListAdapter(Context context, List<NewFileBean.MeetingFileListBean> gridViewBeanList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(
                    R.layout.item_private_file_list, null);
        ...
        viHolder.private_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                privateToPublicInterface.onTransfor(gridViewBean.get_id(), userIdBean.get_id());
    ...
    public interface PrivateToPublicInterface {
