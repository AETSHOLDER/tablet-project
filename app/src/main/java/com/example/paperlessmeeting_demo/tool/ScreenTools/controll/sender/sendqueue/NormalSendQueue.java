...
import static com.example.paperlessmeeting_demo.tool.ScreenTools.entity.Frame.FRAME_TYPE_AUDIO;
import static com.example.paperlessmeeting_demo.tool.ScreenTools.entity.Frame.FRAME_TYPE_INTER_FRAME;
import static com.example.paperlessmeeting_demo.tool.ScreenTools.entity.Frame.FRAME_TYPE_KEY_FRAME;


public class NormalSendQueue implements ISendQueue {
    private String TAG = "NormalSendQueue";
