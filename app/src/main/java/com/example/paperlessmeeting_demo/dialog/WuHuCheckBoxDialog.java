...
import com.example.paperlessmeeting_demo.adapter.CheckBoxAdapter;
...
public class WuHuCheckBoxDialog extends AlertDialog {
   ...
   private    String flag;
    ...
    public WuHuCheckBoxDialog(Context context, @StyleRes int themeResId, List<ChoseBean> dataList, String flag) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wuhu_dialog_checkbox);
