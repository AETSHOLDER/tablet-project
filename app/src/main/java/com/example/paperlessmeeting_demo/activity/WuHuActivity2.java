...
/*
 * 文件分享和推送旧版本功能，去除MD5验证文件是否存在，和WuHuFragment2  PagerAdapter2配合使用
 * */
public class WuHuActivity2 extends BaseActivity implements View.OnClickListener, WuHuNewTopicAdapter.saveSeparatelyInterface, WuHuNewTopicAdapter.deletSeparatelyInterface, WuHuNewTopicAdapter.addSeparatelyInterface, NettyListener {
    ...
    private Handler mHander = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    Toast.makeText(WuHuActivity2.this, "正在接受文件", Toast.LENGTH_SHORT).show();
                    break;
                case 33:
                    //分享 有文件
                ...
                case 400:
                  ...
                  /*  bundle400.putString("flag", "2");
                    ...
                    /*    if ( isActivityTop(ActivityImage.class,WuHuActivity.this)){
                        ...
                        intent99.setClass(WuHuActivity2.this, ActivityImage.class);
                        ...
                        if (UserUtil.isNetworkOnline) {
                            ...
                            intent400.setClass(WuHuActivity2.this, SignActivity.class);
                            ...
                            CVIPaperDialogUtils.showConfirmDialog(WuHuActivity2.this, "当前无外网，会使用wps打开文件", "知道了", false, new CVIPaperDialogUtils.ConfirmDialogListener() {
                                @Override
                                public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                                    startActivity(FileUtils.openFile(fileBean400.getPath(), WuHuActivity2.this));
                                }
                            });
                        }
                    }
                ...
                case 88:
                    ...
                    Toast.makeText(WuHuActivity2.this, "推送文件已成功接收，请在文件管理页面查看", Toast.LENGTH_SHORT).show();
                    ...
                    /*    if ( isActivityTop(ActivityImage.class,WuHuActivity.this)){
                        ...
                        intent9.setClass(WuHuActivity2.this, ActivityImage.class);
                        ...
                        if (UserUtil.isNetworkOnline) {
                            ...
                            intent = new Intent();
                            intent.setClass(WuHuActivity2.this, SignActivity.class);
                            ...
                            CVIPaperDialogUtils.showConfirmDialog(WuHuActivity2.this, "当前无外网，会使用wps打开文件", "知道了", false, new CVIPaperDialogUtils.ConfirmDialogListener() {
                                @Override
                                public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                                    startActivity(FileUtils.openFile(fileBean.getPath(), WuHuActivity2.this));
                                }
                            });
                        }
                    }
...
//                        Log.d("gdhh222", stringsIp.get(i) + "");
                    ...
                    break;
                case 5:
                    Toast.makeText(WuHuActivity2.this, "文件发送成功哈哈哈哈！", Toast.LENGTH_SHORT).show();
                    break;
                case 120:
...
//                    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        wuHuListAdapter = new WuHuNewTopicAdapter(WuHuActivity2.this.mContext, wuHuEditBeanList);
...
//                    Log.e("临时会议", "临时会议的server IP ======" + UrlConstant.TempWSIPString);
        ...
        UDPClientManager.getInstance().receiveUDP(new OnUdpConnectListener() {
            ...
            public void udpConnectSuccess(String ip) {
                ...
                MeetingAPP.getInstance().getNettyClient().setListener(WuHuActivity2.this);
    ...
    public void showUpLoadFileDialog() {
        //自定义dialog显示布局
        inflate = LayoutInflater.from(WuHuActivity2.this).inflate(R.layout.wuhu_netfile_progress_dialog, null);
        //自定义dialog显示风格
        dialog = new MyDialog(WuHuActivity2.this, R.style.dialogTransparent);
    ...
    protected void initView() {
        foodView = LayoutInflater.from(WuHuActivity2.this).inflate(R.layout.list_food, null);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.consult_ll:
                intent = new Intent(WuHuActivity2.this, SignListActivity.class);
                startActivity(intent);
            ...
            case R.id.comfirm:
                ...
                if (edit_name.getText().toString().isEmpty()) {
                    Toast.makeText(WuHuActivity2.this, "名字不能为空！", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                break;
            case R.id.vote_ll:
                intent = new Intent(WuHuActivity2.this, WuHuVoteActivity.class);
                startActivity(intent);
                break;
            case R.id.finish_ll:
            ...
            case R.id.shareScreen_ll1:
                if (UserUtil.isShareScreen) {
                    CVIPaperDialogUtils.showCustomDialog(WuHuActivity2.this, "是否结束投屏?", "", "结束", false, new CVIPaperDialogUtils.ConfirmDialogListener() {
                        @Override
                        public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                            if (clickConfirm) {
                                stopRecording();
    ...
    private void alertShareScreen() {
        shareScreenDialog = new Dialog(WuHuActivity2.this, R.style.update_dialog);
        View view = LayoutInflater.from(WuHuActivity2.this).inflate(R.layout.diaog_sharescreen_code, null);//加载自己的布局
        ...
        shareScreen_codeview.setOnCodeFinishListener(new VerificationCodeView.OnCodeFinishListener() {
            ...
            public void onComplete(View view, String content) {
                if (view == shareScreen_codeview) {
                    closeKeyboardHidden(WuHuActivity2.this);
...
//        ToastUtils.showShort("已停止投屏");
    ...
    public void saveData(int position) {
        ...
        Toast.makeText(WuHuActivity2.this, "保存成功", Toast.LENGTH_SHORT).show();
    ...
    public void deletData(int position) {
        ...
        CVIPaperDialogUtils.showCustomDialog(WuHuActivity2.this, "", "是否要删除当前议题", "确定", true, new CVIPaperDialogUtils.ConfirmDialogListener() {
            @Override
            public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                if (clickConfirm) {
    ...
    private void showFinishMeetingDialog() {
        ...
        CVIPaperDialogUtils.showCustomDialog(WuHuActivity2.this, "确定要结束会议？", "请保存/上传好会议文件!!!", "确定", true, new CVIPaperDialogUtils.ConfirmDialogListener() {
            @Override
            public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                if (clickConfirm) {
                    stopRecording();
                    if (UserUtil.isTempMeeting) {
                        ...
                        if (UrlConstant.baseUrl.equals("http://192.168.1.1:3006")) {
                            Toast.makeText(WuHuActivity2.this, "服务端不在线！", Toast.LENGTH_SHORT).show();
                            UserUtil.user_id = "";
...
*/
                        ...
                        protected void onSuccess(BasicResponse response) {
                            ...
                            try {
                                Log.d("gtgwrtwwrtwt大文件上传分片222", "议题：  " + pos +
                                        ...
                                        Formatter.formatFileSize(WuHuActivity2.this, f.length()) + "   body体内大小： " +
                                        Formatter.formatFileSize(WuHuActivity2.this, requestBody.contentLength()) + "     缓存大小： " + fileFragmentationBeans.size());
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
    ...
    public void showFileTransferDialog() {
        //自定义dialog显示布局
        View inflate = LayoutInflater.from(WuHuActivity2.this).inflate(R.layout.wuhu_netfile_progress_dialog, null);
        //自定义dialog显示风格
        networkFileDialog = new MyDialog(WuHuActivity2.this, R.style.dialogTransparent);
    ...
    public void onReceiveMsg(EventMessage message) {
        ...
        if (message.getType().equals(MessageReceiveType.MessageClient)) {
            if (message.getMessage().contains(constant.START_SHARE_SCEEN)) {
                ...
                Intent inte = new Intent(WuHuActivity2.this, ScreenReceiveActivity.class);
                startActivity(inte);
 ...
 /*       Intent intent = new Intent();
  ...
  /*      if (Hawk.contains("isreuse")) {
    ...
    public void showRightDialog() {
        //自定义dialog显示布局
        inflate = LayoutInflater.from(WuHuActivity2.this).inflate(R.layout.dialog_edit_wuhu, null);
        //自定义dialog显示风格
        dialog = new MyDialog(WuHuActivity2.this, R.style.BottomSheetEdit);
        dialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN | WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
        //弹窗点击周围空白处弹出层自动消失弹窗消失(false时为点击周围空白处弹出层不自动消失)
        ...
        //  纵向滑动
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(WuHuActivity2.this);
...
/*
        ...
        sava_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Hawk.put("company_name", company_name.getText().toString());
                Hawk.put("tittle2", tittle2.getText().toString());
                Toast.makeText(WuHuActivity2.this, "全部保存成功", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
