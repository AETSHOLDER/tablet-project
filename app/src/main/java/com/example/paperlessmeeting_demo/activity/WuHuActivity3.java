    ...
    private Handler mHander = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    Toast.makeText(WuHuActivity3.this, "正在接受文件", Toast.LENGTH_SHORT).show();
                    break;
                case 33:
                    //分享 有文件
                    Toast.makeText(WuHuActivity3.this, "文件已成功接收，请在文件管理页面查看", Toast.LENGTH_SHORT).show();
                    ...
                    break;
                case 4:
                    Toast.makeText(WuHuActivity3.this, "文件接收失败", Toast.LENGTH_SHORT).show();
                    break;
                case 400:
                    //推送  有文件
                ...
                case 88:
                    ...
                    Toast.makeText(WuHuActivity3.this, "推送文件已成功接收，请在文件管理页面查看", Toast.LENGTH_SHORT).show();
...
//                        Log.d("gdhh222", stringsIp.get(i) + "");
                        ...
                        for (int i = 0; i < stringsIp.size(); i++) {
                            Log.d("stringListIp=存储", stringsIp.get(i));
                    ...
                    break;
                case 5:
                    Toast.makeText(WuHuActivity3.this, "文件发送成功哈哈哈哈！", Toast.LENGTH_SHORT).show();
                    break;
                case 120:
        ...
        if (UserUtil.isNetDATA) {
            ...
            if (Hawk.contains("WuHuMeetingListResponse")) {
                ...
                if (contentDTO == null || contentDTO.getEditListBeanList() == null || contentDTO.getEditListBeanList().size() < 1) {
                    Toast.makeText(WuHuActivity3.this, "数据加载异常，请退出重新进入", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//gtgwrtwwrtwt大文件上传分片--
                ...
                Log.d("paichayuanyin", "初始化请求拿到文件数据");
                ...
                if (Hawk.contains("WuHuFragmentData")) {
                  ...
                  /*  new Thread(new Runnable() {
                    ...
                    Log.d("paichayuanyin", "初始化请求拿到的所有数据");
                    //整理投票类
        ...
        switch (v.getId()) {
            ...
            case R.id.comfirm:
                ...
                if (edit_name.getText().toString().isEmpty()) {
                    Toast.makeText(WuHuActivity3.this, "名字不能为空！", Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            case R.id.shareScreen_ll1:
                if (UserUtil.isShareScreen) {
                    CVIPaperDialogUtils.showCustomDialog(WuHuActivity3.this, "是否结束投屏?", "", "结束", false, new CVIPaperDialogUtils.ConfirmDialogListener() {
                        @Override
                        public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                            if (clickConfirm) {
                                stopRecording();
    ...
    private void alertShareScreen() {
        ...
        View view = LayoutInflater.from(WuHuActivity3.this).inflate(R.layout.diaog_sharescreen_code, null);//加载自己的布局
...
//        ToastUtils.showShort("已停止投屏");
    ...
    public void deletData(int position) {
        ...
        CVIPaperDialogUtils.showCustomDialog(WuHuActivity3.this, "", "是否要删除当前议题", "确定", true, new CVIPaperDialogUtils.ConfirmDialogListener() {
            @Override
            public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                if (clickConfirm) {
    ...
    private void showFinishMeetingDialog() {
        ...
        CVIPaperDialogUtils.showCustomDialog(WuHuActivity3.this, str, "请保存/上传好会议文件!!!", "确定", true, new CVIPaperDialogUtils.ConfirmDialogListener() {
            @Override
            public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                if (clickConfirm) {
                    stopRecording();
                    if (UserUtil.isTempMeeting) {
                        ...
                        if (UrlConstant.baseUrl.equals("http://192.168.1.1:3006")) {
                            Toast.makeText(WuHuActivity3.this, "服务端不在线！", Toast.LENGTH_SHORT).show();
                            UserUtil.user_id = "";
                        ...
                        protected void onSuccess(BasicResponse response) {
                            ...
                            try {
                                Log.d("gtgwrtwwrtwt大文件上传分片----90", "议题：  " + pos +
                                        ...
                                        Formatter.formatFileSize(WuHuActivity3.this, f.length()) + "   body体内大小： " +
                                        Formatter.formatFileSize(WuHuActivity3.this, requestBody.contentLength()) + "     缓存大小： " + fileFragmentationBeans.size());
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
                    ...
                    try {
                        ...
                        if (wsebean != null) {
                            ...
                            if (wsebean.getBody() == null || wsebean.getBody().size() < 1) {
                                ...
                                Toast.makeText(WuHuActivity3.this, "数据查询异常，请退出重新进入", Toast.LENGTH_SHORT).show();
                                return;
                            }
        ...
        NetWorkManager.getInstance().getNetWorkApiService().getWuHuMeetingInfo(id).compose(this.bindToLifecycle())
                ...
                .subscribe(new DefaultObserver<BasicResponse<WuHuMeetingListResponse>>() {
                    ...
                    protected void onFail(BasicResponse<WuHuMeetingListResponse> response) {
                        ...
                        JWebSocketClientService.closeConnect();
                        finish();
                        Toast.makeText(WuHuActivity3.this, "数据异常，请重新进入会议！", Toast.LENGTH_SHORT).show();
...
/*
        ...
        sava_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Hawk.put("company_name", company_name.getText().toString());
                Hawk.put("tittle2", tittle2.getText().toString());
                Toast.makeText(WuHuActivity3.this, "全部保存成功", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
