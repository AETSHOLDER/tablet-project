...
public class MainActivity3 extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        copy();
        tt = (TextView) findViewById(R.id.aa);
        tt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //FileDisplayActivity.show(MainActivity3.this, path);
            }
        });
    ...
    public void onPermissionsGranted(int requestCode, List<String> perms) {
        ...
        Toast.makeText(MainActivity3.this, "授权成功", Toast.LENGTH_LONG).show();
    ...
    public void onPermissionsDenied(int requestCode, List<String> perms) {
        Toast.makeText(MainActivity3.this, "用户授权失败", Toast.LENGTH_LONG).show();
        /**
