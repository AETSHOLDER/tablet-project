 ...
 *  "我的"白板
 * */
public class MyWhiteFragment extends BaseFragment implements View.OnClickListener, DrawPenView.sendSingleFile, WhiteBoardActivity2.ToFragmentListener{
    ...
    */
    ...
    private MyWhiteFragment.MyReceiver myRedoReceiver;
    private boolean isConnected = false;
    private  boolean isfirstinit = true;
    private final String TAG = "MyWhiteFragment";
...
//            mIvWhiteBoardShare2.setVisibility(View.GONE);
        }
    }
        ...
        mDbView.post(new Runnable() {
            ...
            public void run() {
                ...
                if(isfirstinit){ // 防止串数据
                    ...
                    OperationUtils.getInstance().setmWhiteBoardPoints(OperationUtils.getInstance().getmWhiteBoardPointList().get(1));
                }
                showPoints();
            }
        });
...
//        showPageVisiable();
    ...
    private void sendRedoMsg() {
        if (!isConnected || !JWebSocketClientService.client.isOpen()) {
            return;
        }
...
//        mRlContent.setLayoutParams(mLayoutParams);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myRedoReceiver = new MyWhiteFragment.MyReceiver();
...
//            return;
//        }
////        Log.e("临时白板", "onReceiveMsg: " + message.toString());
//        try {
//
...
//    }
    ...
    public void onTypeClick(ToFragmentType toFragmentType, ToFragmentIsConnectedType isConnected) {
        ...
        switch (toFragmentType) {
            case SaveData:
                OperationUtils.getInstance().setmWhiteBoardPointList(getInstance().getWhiteBoardPoints(),1);
                break;
            case Close:
                mDbView.clearImage();
                break;
