...
public class ExtraordMeetingFragment2 extends BaseFragment implements VerificationCodeView.OnCodeFinishListener, WuHuMeetingListAdapter.onItemInterface {
...
//                    Toast.makeText(SignActivity.this, "文件分享失败", Toast.LENGTH_SHORT).show();
    ...
    public ExtraordMeetingFragment2() {
                    ...
                    CVIPaperDialogUtils.showCustomDialog(getActivity(), "已存在创建码", null, "可重复创建", false, new CVIPaperDialogUtils.ConfirmDialogListener() {
                        ...
                        public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                            if (clickConfirm) {
                                ...
                                Intent intent2 = new Intent(getActivity(), WuHuActivity3.class);
                                Bundle bundle = new Bundle();
                                bundle.putString("ip", ipcodeInfo.get(0));
                                bundle.putString("isreuse", isRu);
                        ...
                        public void onClickButton(boolean clickConfirm, boolean clickCancel) {
                            if (clickConfirm) {
                                if (!isReuse) {
                                    ...
                                    Intent intent = new Intent(getActivity(), WuHuActivity3.class);
                                    Bundle bundle = new Bundle();
