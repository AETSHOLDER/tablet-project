...
public class MultiStateView extends FrameLayout {
    ...
    private OnClickErrorViewListener onClickErrorViewListener;
    ...
    public void setOnClickErrorViewListener(OnClickErrorViewListener listener) {
        this.onClickErrorViewListener = listener;
        if (onClickErrorViewListener != null) {
            mErrorView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    setViewState(VIEW_STATE_LOADING);
                    onClickErrorViewListener.onClick();
                }
            });
        }
    }

    public void setOnClickEmptyViewListener(OnClickEmptyViewListener listener) {
        this.onClickEmptyViewListener = listener;
        if (onClickEmptyViewListener != null) {
            mEmptyView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    setViewState(VIEW_STATE_LOADING);
                    onClickEmptyViewListener.onClick();
                }
            });
        }
    }
